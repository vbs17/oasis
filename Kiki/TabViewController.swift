...
class TabViewController: UIViewController {
    ...
    func setupTab() {
        ...
        let settingViewController = storyboard?.instantiateViewControllerWithIdentifier("Set")
        ...
        tabBarController.setAction({
            let imageViewController = self.storyboard?.instantiateViewControllerWithIdentifier("Top")
